...
for (i = 0; i < tarjeta.length; i++) {
    ...
    aTag3.setAttribute('class','enlaces-oscuros');
    aTag3.innerHTML = 'Borrar Artista ';
    aTag3.setAttribute('href','borrarartista/'+nombre[i].childNodes[0].textContent);
...
var seccion = document.getElementById('artistas');
//seccion.appendChild(nuevalinea);
seccion.appendChild(document.createElement('hr'));
var aTag2 = document.createElement('a');
aTag2.setAttribute('href','nuevoartista');
aTag2.setAttribute('class','btn btn-info');
aTag2.innerHTML = '<br>Añadir Artista<br><br>';
